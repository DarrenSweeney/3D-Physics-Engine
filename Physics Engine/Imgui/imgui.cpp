...
/*
	* BEGIN: Physics Engine GUI *
*/
void ImGui::PhysicsEngineGUI(bool *opened)
{
	...
	if (!ImGui::Begin("3D_Physics_Engine_0.1.0", opened, ImVec2(500, 600), bg_alpha, window_flags))
	{
	...
	{
		ImGui::TextWrapped("This is an early look into my 3D physics engine. Created by Darren Sweeney");
	}

	ImGui::End();
}
/*
	* END: Physics Engine GUI *
*/
...
struct ExampleAppConsole
{
    ...
    void    ExecCommand(const char* command_line)
    {
		...
		else if (ImStricmp(command_line, "Darren") == 0)
		{
			AddLog("Darren Sweeney is making a cool physics engine");
		}
        else
        {
